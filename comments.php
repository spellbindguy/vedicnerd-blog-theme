...
<table>
<tr>
<td class="commentFormTd"><label>Name: <br><em>Required</em> <input type="text" name="author" id="author" value="<?php echo $comment_author; ?>" /></label></td>
<td class="commentFormTd"><label>Email: <br><em>Required, not published</em> <input type="text" name="email" id="email" value="<?php echo $comment_author_email; ?>" /></label></td>
<td class="commentFormTd"><label>Homepage: <br><em>Why not?</em><input type="text" name="url" id="url" value="<?php echo $comment_author_url; ?>" /></label></td>
</tr></table></div>
        <label>Comment:<br>
